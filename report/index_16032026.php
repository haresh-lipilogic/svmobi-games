...
<body>
 ...
 <a href="logout.php" class="logout">Logout</a>
  ...
  <main class="main">
    ...
    <div class="stats">
      <div class="stat-card"><h3>Your Revenue</h3><p><?php echo $yourrev;?></p></div>
      <div class="stat-card"><h3>Total Revenue</h3><p><?php echo $totalrevenue;?></p></div>
      <div class="stat-card"><h3>Ad Impressions</h3><p><?php echo $impressions;?></p></div>
      <div class="stat-card"><h3>eCPM</h3><p><?php echo $ecpm;?></p></div>
		  ...
		  while($row1=mysqli_fetch_array($result1))
			{
				...
				echo "<tr><td>".$row1['reportdate']."</td><td>".$row1['totalrevenue']*$revenueshare."</td><td>".$row1['totalrevenue']."</td><td>".$row1['impressions']."</td><td>".$row1['ecpm']."</td><td>".$row1['clicks']."</td></tr>"	;	
